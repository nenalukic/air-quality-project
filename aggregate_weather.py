...
spark = SparkSession.builder \
    .appName("WeatherColumnAggregations") \
    .getOrCreate()

# Read your partitioned data from Parquet files
data_df = spark.read.parquet("weather_historical_partitioned")
...
aggregated_df.write.parquet("aggregated_weather_historical_data")
